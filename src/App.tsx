      ...
      <div >
        ...
        <section className='mb-[120px] px-[20px] mt-[30px] pb-[60px] py-[20px] bg-[#f6fbff]'>
          <div className='img flex items-center gap-[35px]'>
            ...
            <span className='text-gray-400'>Need more? Build your own trading and investing experience with Kite Connect, simple HTTP APIs to place orders, stream market data, manage your account, and more. </span>
            ...
            <div className='grid items-start gap-12 lg:grid-cols-[0.95fr_1.35fr]'>
              ...
              <div className='grid gap-8 md:grid-cols-3'>
                <div className='pricing-card flex flex-col items-center text-center gap-3'>
                  ...
                  <p className='text-lg leading-6 text-[#424242]'>
                    Free account
                    <br />
                    opening
                  </p>
